        ...
        <table className="min-w-full bg-white border border-gray-200 rounded-lg">
          <thead>
            <tr>
              ...
              <th className="py-3 px-4 border border-gray-200  text-left max-sm:hidden">
                Location
              </th>
              <th className="py-3 px-4 border border-gray-200  text-left max-sm:hidden">
                Date
          ...
          <tbody>
            {jobsApplied.map((job, index) =>
              true ? (
                <tr>
                  <td className="py-3 px-4 flex  items-center gap-2 border border-gray-200 ">
                    <img className="w-8 h-8" src={job.logo} alt="" />
                    {job.company}
                  </td>
                  <td className="py-2 px-4  border border-gray-200  ">{job.title}</td>
                  <td className="py-2 px-4  border border-gray-200  max-sm:hidden">
                    {job.location}
                  </td>
                  <td className="py-2 px-4 border border-gray-200  max-sm:hidden">
